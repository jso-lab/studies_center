 ...
 */
final class Version20220323092046 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE learner ADD roles LONGTEXT NOT NULL COMMENT \'(DC2Type:array)\'');
    }

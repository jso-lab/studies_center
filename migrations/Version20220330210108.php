 ...
 */
final class Version20220330210108 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teacher ADD role_id INT NOT NULL, ADD descritpion LONGTEXT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE teacher DROP role_id, DROP descritpion');
    }
}

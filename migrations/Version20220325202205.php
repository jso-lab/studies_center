 ...
 */
final class Version20220325202205 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE lesson ADD ressources LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\', CHANGE description description LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`');
